...
//         { error: "Authentication required. Session invalid or expired." },
//         { status: 401 },
//       );
//     }
...
//       return NextResponse.json(
//         { error: "Data validation error", details: validation.error.errors },
//         { status: 400 },
//       );
//     }
...
//     let { data: dbExecution, error: dbError } = await supabaseAdmin.rpc(
//       "create_order_atomic",
//       {
...
//       return NextResponse.json(
//         { error: dbExecution?.error || "Database transaction failure." },
//         { status: 500 },
//       );
//     }
...
//         cus_name: user.user_metadata?.full_name || "Verified Customer",
//         cus_email: user.email,
//         cus_add1: shippingDetails.address,
//         cus_phone: shippingDetails.phone,
//         shipping_method: "NO",
//         product_name: "Nazrul Publication Checkout",
...
//       return NextResponse.json(
//         { error: "Payment engine initialization failure" },
//         { status: 502 },
//       );
//     }
...
//   } catch (err) {
//     return NextResponse.json(
//       { error: "Internal Secure Processing Server Error Intercepted" },
//       { status: 500 },
//     );
//   }
// }
...
//       required_error: "Shipping location region classification is mandatory.",
//     }),
//   }),
//   paymentMethod: z.enum(["sslcommerz", "cod", "cash_on_delivery"]),
// });
...
//     if (!validation.success) {
//       return NextResponse.json(
//         { error: "Validation failure.", details: validation.error.errors },
//         { status: 400 },
//       );
//     }
...
//     // Pass parameters down to secure stored database calculations
...
//     if (dbError || !dbExecution?.success) {
//       return NextResponse.json(
//         { error: dbExecution?.error || "Transaction process error." },
//         { status: 500 },
//       );
//     }
...
//         cus_phone: shippingDetails.phone,
//         shipping_method: "NO",
//         product_name: "Nazrul Publication Purchase",
...
//       }
//       return NextResponse.json(
//         { error: "Gateway verification handshake dropped." },
//         { status: 502 },
//       );
//     }
...
//   } catch (err) {
//     return NextResponse.json(
//       { error: "Fatal order execution interface fallback runtime exception." },
//       { status: 500 },
//     );
//   }
// }
