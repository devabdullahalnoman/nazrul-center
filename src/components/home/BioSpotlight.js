...
//             <div className="inline-flex px-3 py-1 rounded-md bg-nazrul-crimson/10 text-nazrul-crimson font-bold text-xl uppercase tracking-widest">
//               The Rebel Poet
//             </div>

//             <h2 className="text-3xl md:text-5xl font-black text-nazrul-terracotta leading-tight">
