...
export default function Navbar() {
  const navLinks = (
    <>
      ...
      <li>
        <Link href="/docu-film">Documentary Film</Link>
      </li>
      <li>
        <Link href="/shop">Books & Gifts</Link>
      </li>

      {/* DROPDOWN MENU - Fixed with "Bridge" logic */}
      <li className="dropdown dropdown-hover">
        <div
          tabIndex={0}
          role="button"
          className="flex items-center gap-1 py-4 px-2 cursor-default"
        >
          Media & News
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        {/* 1. mt-0 ensures there is no gap at the top.
          2. pt-4 inside the menu acts as a "bridge" for the mouse cursor.
        */}
        <ul
          tabIndex={0}
          className="dropdown-content z-1 menu p-2 shadow-xl bg-base-100 rounded-box w-40 border border-base-200 m-0"
          style={{ top: "90%" }}
        >
          <li>
  ...
  return (
    <div className="navbar bg-base-100 shadow-md sticky top-0 z-100 px-2 md:px-8">
      ...
      {/* Desktop Menu */}
      <div className="navbar-center hidden xl:flex">
        <ul className="menu menu-horizontal px-1 font-semibold gap-1 items-center">
          {navLinks}
        </ul>
      </div>
