      ...
      <div className="w-full max-w-480 mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 xl:gap-12 mb-10">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p
              className={`${commonFontSize} text-gray-600 font-medium leading-relaxed max-w-sm`}
            >
              Preserving and celebrating the timeless literary, musical, and
              revolutionary heritage of Kazi Nazrul Islam for generations to
              come.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 list-none m-0 p-0">
              <li>
                <Link
                  href="/biography"
                  className={`${commonFontSize} ${commonWeight} text-gray-600 hover:text-nazrul-crimson transition-colors`}
                >
                  Biography
                </Link>
              </li>
            ...
            <ul className="flex flex-col gap-3.5 list-none m-0 p-0 text-gray-600">
              <li className="flex items-start gap-2.5">
                ...
                <span className={`${commonFontSize} font-medium`}>
                  404/1/A East Kazipara, Mirpur, Dhaka 1216
                </span>
              </li>
              ...
              <li className="flex items-center gap-2.5">
                ...
                <a
                  href="mailto:nazrulcenterdhaka@gmail.com"
                  className={`${commonFontSize} font-medium hover:text-nazrul-crimson transition-colors`}
                >
                  nazrulcenterdhaka@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p
              className={`${commonFontSize} text-gray-600 font-medium leading-relaxed`}
            >
              Subscribe to receive updates on historical discoveries, events,
        ...
        <div className="border-t border-gray-300/40 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5 text-gray-500">
            ...
            <a
              href="#"
              aria-label="Facebook"
              className="hover:text-nazrul-crimson transition-colors"
            >
              <svg
