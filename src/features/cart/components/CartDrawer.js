...
//   // Hydration fix: ensures client-side cart data matches server-side initial render
//   useEffect(() => {
//     setMounted(true);
//   }, []);
...
//               <h2 className="text-xl font-serif font-bold tracking-tight">Your Selection</h2>
//             </div>
//             <button
//               onClick={onClose}
...
//                 </div>
//                 <p className="font-serif italic text-gray-500 text-lg">Your archive is currently empty.</p>
//                 <button
//                   onClick={onClose}
...
//                   <div className="relative w-20 h-24 bg-white rounded-xl overflow-hidden border border-nazrul-sand/10 flex-shrink-0 shadow-sm">
//                     <Image
//                       src={item.image}
//                       alt={item.name}
//                       fill
...
//                         </button>
//                         <span className="px-3 text-xs font-bold text-nazrul-ink">{item.quantity}</span>
//                         <button
//                           onClick={() => updateQuantity(item.id, item.quantity + 1)}
//                           className="p-1.5 hover:bg-gray-50 transition-colors"
//                         >
...
//                 <span className="font-serif italic text-gray-500">Estimated Total</span>
//                 <span className="text-2xl font-black text-nazrul-ink">৳{getTotalPrice()}</span>
//               </div>

//               {/* IMPORTANT: Link component for navigation */}
//               <Link
//                 href="/checkout"
//                 onClick={onClose}
